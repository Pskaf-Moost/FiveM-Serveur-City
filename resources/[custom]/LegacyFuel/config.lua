...
Config.Strings = {
	...
	FullTank = "Réservoir plein",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour acheter un bidon d'essence ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E ~w~pour annuler le plein",
	CancelFuelingJerryCan = "Appuyez sur ~g~E ~w~pour arrêter de remplir le bidon",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir le bidon ",
	NotEnoughCashJerryCan = "Pas assez d'argent pour remplir le bidon",
